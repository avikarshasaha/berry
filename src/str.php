...
////////////////////////////////////////////////////////////////////////////////
    ...
    static function gzip($output, $compress = 3){
        ...
        if (function_exists('ob_gzhandler')){
            $output = ob_gzhandler($output, $compress);
        } else {
            $size = strlen($output);
            $crc  = crc32($output);
