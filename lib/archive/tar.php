...
class tar
{
   ...
   */
  function tar($p_filen = ARCHIVE_DYNAMIC , $p_comptype = COMPRESS_AUTO, $p_complevel = 9)
  {
  ...
  {
    $this->_CompTar();
    $this->tar($p_name, $p_comp, $p_level);
    return $this->_result;
  }
...
<?php
  ...
  function _extractList($p_to, $p_files, $p_remdir, $p_mode = 0755)
  {
    ...
    if (!$p_to || ($p_to[0]!="/"&&substr($p_to,0,3)!="../"&& ($p_to[1] != ':' and $p_to[1] != '\\')))
      $p_to = "./$p_to";
